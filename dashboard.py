...
with col1 :
  ...
  # Plotting the first set of points
    ...
    ax.tick_params(axis='both', which='both', length=4, width=0.5)
...
with col3 :
  # column 1 에 담을 내용
    ...
    # # Plotting additional points
    ax.plot(data4_1CLx, np.concatenate((data4_1Hhy.value_high[:(len(data4_1CLx) - 6)], data4_2Hhy.value_high)), linestyle='-', marker='o', color='red', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Hhy.value_high[:(len(data4_1CLx) - 6)], data4_12Hhy.value_high)), linestyle='--', marker='o', color='red', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Hhy.value_high[:(len(data4_1CLx) - 6)], data4_13Hhy.value_high)), linestyle='--', marker='o', color='red', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Hhy.value_high[:(len(data4_1CLx) - 6)], data4_15Hhy.value_high)), linestyle='--', marker='o', color='red', linewidth=1)
    
    ax.plot(data4_1CLx, np.concatenate((data4_1Hhy.value_high[:(len(data4_1CLx) - 6)], data4_3Hhy.value_high)), linestyle='--', marker='o', color='blue', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Hhy.value_high[:(len(data4_1CLx) - 6)], data4_4Hhy.value_high)), linestyle='--', marker='o', color='blue', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Hhy.value_high[:(len(data4_1CLx) - 6)], data4_5Hhy.value_high)), linestyle='--', marker='o', color='blue', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Hhy.value_high[:(len(data4_1CLx) - 6)], data4_6Hhy.value_high)), linestyle='--', marker='o', color='blue', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Hhy.value_high[:(len(data4_1CLx) - 6)], data4_7Hhy.value_high)), linestyle='--', marker='o', color='green', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Hhy.value_high[:(len(data4_1CLx) - 6)], data4_8Hhy.value_high)), linestyle='--', marker='o', color='green', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Hhy.value_high[:(len(data4_1CLx) - 6)], data4_9Hhy.value_high)), linestyle='--', marker='o', color='green', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Hhy.value_high[:(len(data4_1CLx) - 6)], data4_10Hhy.value_high)), linestyle='--', marker='o', color='green', linewidth=1)
...
with col4 :
    ...
    ax.plot(data4_1CLx, np.concatenate((data4_1Lwy.value_low[:(len(data4_1CLx) - 6)], data4_3Lwy.value_low)), linestyle='--', marker='o', color='blue', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Lwy.value_low[:(len(data4_1CLx) - 6)], data4_4Lwy.value_low)), linestyle='--', marker='o', color='blue', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Lwy.value_low[:(len(data4_1CLx) - 6)], data4_5Lwy.value_low)), linestyle='--', marker='o', color='blue', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Lwy.value_low[:(len(data4_1CLx) - 6)], data4_6Lwy.value_low)), linestyle='--', marker='o', color='blue', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Lwy.value_low[:(len(data4_1CLx) - 6)], data4_7Lwy.value_low)), linestyle='--', marker='o', color='green', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Lwy.value_low[:(len(data4_1CLx) - 6)], data4_8Lwy.value_low)), linestyle='--', marker='o', color='green', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Lwy.value_low[:(len(data4_1CLx) - 6)], data4_9Lwy.value_low)), linestyle='--', marker='o', color='green', linewidth=1)
    ax.plot(data4_1CLx, np.concatenate((data4_1Lwy.value_low[:(len(data4_1CLx) - 6)], data4_10Lwy.value_low)), linestyle='--', marker='o', color='green', linewidth=1)
