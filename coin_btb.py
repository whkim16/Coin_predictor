...
st.markdown(f'### 3. B U Y or S E L L , 예측날짜:  {formatted_date} 00시 기준')
...
# Plotting the first set of points
    ...
    ax.plot(data4_1CLx[:(len(data4_1Hhy0.value_high)+1)], (data4_1Hhy0.value_high), linestyle='--', marker='*', color='black', linewidth=1)
    ax.plot(data4_1CLx[:(len(data4_1Lwy0.value_low)+1)], (data4_1Lwy0.value_low), linestyle='--', marker='*', color='black', linewidth=1)
