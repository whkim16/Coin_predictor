...
hide_github_icon = """
.css-1jc7ptx, .e1ewe7hr3, .viewerBadge_container__1QSob, .styles_viewerBadge__1yB5_, .viewerBadge_link__1S137, 
...
# st.title("데시보드")
# st.markdown(f'### 1. 가격 날짜: {formatted_date}  ,  9시 기준')
